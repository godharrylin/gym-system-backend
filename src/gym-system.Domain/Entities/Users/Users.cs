...
namespace gym_system.Domain.Entities.Users
{
    public sealed class User
    {
        ...
        private User(string id, string name, string phone, string passwordHash, bool isActive)
        {
            Id = id;
            Name = name;
            Phone = phone;
        ...
        //  回填
        public static User Rehydrate(string id, string name, string phone, string passwordHash, bool isActive)
        {
            ...
            return new User(id, name.Trim(), phone.Trim(), passwordHash.Trim(), isActive);
        }
